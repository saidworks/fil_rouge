                    ...
                    <table class='min-w-full divide-y divide-gray-200'>
                        <thead>
                            <tr>
                                ...
                                <th class="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase bg-gray-50">Image</th>
                                <th class="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase bg-gray-50">body</th>
                        ...
                        <tbody class="min-w-full divide-y divide-gray-200">
                            <?php if($data->count()): ?>
                                ...
                                <tr>
                                    <td class="px-6 py-3 text-sm whitespace-no-wrap"><?php echo $item->title; ?></td>
                                    <td class="w-16 px-6 py-3 text-sm whitespace-no-wrap md:w-32 lg:w-48"><img src="<?php echo e(asset('storage/img/'.$item->image)); ?>"></td>
                                    <td class="px-6 py-3 text-sm whitespace-no-wrap"><?php echo $item->body; ?></td>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mt-4">
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.label','data' => ['for' => 'body','value' => ''.e(__('body')).'']]); ?>
<?php $component->withName('jet-label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['for' => 'body','value' => ''.e(__('body')).'']); ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
</div><?php /**PATH C:\Users\saidworks\Desktop\workshops\fil_rouge\Protech_Tetouan\resources\views/livewire/annonces.blade.php ENDPATH**/ ?>