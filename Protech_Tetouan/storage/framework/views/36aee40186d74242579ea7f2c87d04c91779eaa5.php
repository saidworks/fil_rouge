                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-3 text-sm whitespace-no-wrap">
                                        <span class="text-indigo-600 hover:text-indigo-900">
                                             <?php echo e($item->email); ?></span></td>
                                    <td class="px-6 py-3 text-sm whitespace-no-wrap"><?php echo $item->role; ?></td>
                                    <td class="px-6 py-3 text-sm whitespace-no-wrap">
...
<?php endif; ?> 
                    ...
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.input','data' => ['id' => 'email','class' => 'block w-full mt-1 transition duration-150 ease-in-out rounded rounded-r-md sm:text-sm sm:leading-5','wire:model.debounce.800ms' => 'email','type' => 'email','name' => 'email','placeholder' => 'email']]); ?>
<?php $component->withName('jet-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'email','class' => 'block w-full mt-1 transition duration-150 ease-in-out rounded rounded-r-md sm:text-sm sm:leading-5','wire:model.debounce.800ms' => 'email','type' => 'email','name' => 'email','placeholder' => 'email']); ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['wire:model' => 'modalFormDeleteVisible']); ?>
         ...
         <?php $__env->slot('content'); ?> 
            <?php echo e(__('Are you sure you want to delete this User? Once this user is deleted, all of its resources and data will be permanently deleted.')); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
</div><?php /**PATH C:\Users\saidworks\Desktop\workshops\fil_rouge\Protech_Tetouan\resources\views/livewire/users.blade.php ENDPATH**/ ?>