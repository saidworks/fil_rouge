                        ...
                        <tbody class="min-w-full divide-y divide-gray-200">
                            <?php if($data->count()): ?>
                                ...
                                <tr>
                                    ...
                                    <?php echo $item->is_default_home ? '<span class="text-xs font-bold text-green-400">[Default Home Page]</span>' : ''; ?>

                                    <?php echo $item->is_default_not_found ? '<span class="text-xs font-bold text-red-400">[Default Not Found Page]</span>' : ''; ?>

                                    </td>
                                    <td class="px-6 py-3 text-sm whitespace-no-wrap">
                                        <a class="text-indigo-600 hover:text-indigo-900"
                                            href="<?php echo e(URL::to('/'.$item->slug)); ?>" 
                                            target="_blank"> <?php echo e($item->slug); ?></a></td>
                                    <td class="flex flex-wrap max-w-xs px-6 py-3 text-sm"><?php echo $item->content; ?></td>
                                    <td class="px-6 py-3 text-sm whitespace-no-wrap">
                                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?>
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.input','data' => ['id' => 'title','class' => 'block w-full mt-1','type' => 'text','name' => 'title','wire:model.debounce.800ms' => 'title']]); ?>
<?php $component->withName('jet-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'title','class' => 'block w-full mt-1','type' => 'text','name' => 'title','wire:model.debounce.800ms' => 'title']); ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
...
<?php endif; ?> 
                    ...
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.input','data' => ['id' => 'slug','class' => 'block w-full mt-1 transition duration-150 ease-in-out rounded rounded-r-md sm:text-sm sm:leading-5','wire:model.debounce.800ms' => 'slug','type' => 'text','name' => 'slug','placeholder' => 'url-slug']]); ?>
<?php $component->withName('jet-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'slug','class' => 'block w-full mt-1 transition duration-150 ease-in-out rounded rounded-r-md sm:text-sm sm:leading-5','wire:model.debounce.800ms' => 'slug','type' => 'text','name' => 'slug','placeholder' => 'url-slug']); ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mt-4">
                    <label for="">
                        <input class="form-checkbox" type="checkbox" value="<?php echo e($isSetToDefaultHomePage); ?>" wire:model="isSetToDefaultHomePage">
                        <span class="ml-2 text-sm text-gray-600">Set as the default Home Page</span>
                    </label>
                </div>  
                <div class="mt-4">
                    <label for="">
                        <input class="form-checkbox" type="checkbox" value="<?php echo e($isSetToDefaultNotFoundPage); ?>" wire:model="isSetToDefaultNotFoundPage">
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
</div><?php /**PATH C:\Users\saidworks\Desktop\workshops\fil_rouge\Protech_Tetouan\resources\views/livewire/pages.blade.php ENDPATH**/ ?>