                        ...
                        <tbody class="min-w-full divide-y divide-gray-200">
                            @if ($data->count())
                                ...
                                <tr>
                                    ...
                                    <td class="w-16 px-6 py-3 text-sm whitespace-no-wrap md:w-32 lg:w-48"><img src="{{ asset('storage/img/'.$item->image) }}"></td>
                                    <td class="px-6 py-3 text-sm whitespace-no-wrap">{!! $item->body !!}</td>
